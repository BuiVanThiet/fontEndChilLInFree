                                ...
                                <div className="w-full xl:w-1/2">
                                    <Row>
                                        ...
                                        <Col span={24} className="mt-3 text-lg">
                                            Tên đăng nhập:
                                            <Input size="large" className="mt-1" placeholder="Tên đăng nhập, SĐT, Email..." value={this.state.username} onChange={(e) => this.onchangeAcount('username',e.target.va)}/>
                                        </Col>
                                        <Col span={24} className="mt-3 text-lg">
                                            Mật khẩu:
                                            <Input.Password size="large" className="mt-1" placeholder="Mật khẩu..." value={this.state.password} />
                                        </Col>
