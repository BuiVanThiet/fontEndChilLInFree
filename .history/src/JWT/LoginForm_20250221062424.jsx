                ...
                <Card type="inner" className="w-[90%]">
                    <div className="flex flex-col xl:flex-row gap-4">
                        ...
                        <div className="flex flex-col items-center justify-center xl:border-l-4 xl:border-red-600 order-first xl:order-last w-full xl:w-1/2">
                            <img src={iconBird} className="w-max h-32 xl:h-48 object-contain max-h-[100px]" alt="React logo" />
                            <img src={chillnfreelogo} className="w-max h-32 xl:h-48 object-contain max-h-[100px]" alt="React logo" />
                        </div>

                        {/* Cột 1 - Đăng nhập */}
                        <div className="w-full xl:w-1/2">
                            <Row>
                                <Col span={24} className="flex font-sans text-[50px] fo items-center justify-center text-red-600">
                                    Đăng nhập
                                </Col>
