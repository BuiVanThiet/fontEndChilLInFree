                    ...
                    <div className="flex flex-col xl:flex-row gap-4">
                        ...
                        <div className="w-full xl:w-1/2">
                            <Row>
                                ...
                                <Col span={24} className="mt-3  flex flex-col xl:flex-row justify-between items-center gap-2">
                                    <Button className="bg-red-600" color="danger" variant="dashed" block>
                                        Đăng nhập
                                    </Button>
                                    <div className="text-center xl:text-left xl:order-first bg-red-600">
