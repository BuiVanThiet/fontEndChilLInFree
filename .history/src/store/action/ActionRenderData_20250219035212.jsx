...
export const removeCommas = (str) => {
    if (typeof str !== "string") {
        return str; // Nếu không phải chuỗi, trả về giá trị ban đầu
    }
    return str.includes(",") ? str.replace(/,/g, "") : str;
};

// ✅ Kiểm tra lại với các kiểu dữ liệu khác nhau:
console.log(removeCommas("1,234,567")); // "1234567"
console.log(removeCommas(12345)); // 12345 (không bị lỗi)
console.log(removeCommas(null)); // null (không bị lỗi)
console.log(removeCommas(undefined)); // undefined (không b
