...
const RootReducer = createSlice({
    ...
    reducers: {
        ...
        SET_CHECK_LOGIN: (state,action) => {
            state.checkLogin = state.payload
        }
    }
});

// ✅ Export actions cho Redux Thunk
export const { OPEN_CARD_ORDER, CLONE_CARD_ORDER, CLICK_ATTIBUTE_TYPE, START_LOADING, UPDATE_PROGRESS, STOP_LOADING, SET_CHECK_LOGIN } = RootReducer.actions;
