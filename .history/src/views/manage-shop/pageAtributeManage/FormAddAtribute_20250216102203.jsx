...
class FormAddAtribute extends React.Component {
    ...
    validateAdd = async () => {
        ...
        const checkSameCode = checkDuplicate(code, listCheck, 1);
        console.log('code kiem tra: ', code)
                    ...
                    <Row gutter={[16, 16]} >
                        <Col span={12} >
                            ...
                            <span className="text-red-600">
                                {validateString(this.state.code) === true ? '' : '*Mã thuộc tính ' + validateString(this.state.code)}
                                {checkDuplicate(this.state.code, this.state.listCheckSame, 1) === true ? '' : '*Mã thuộc tính 'checkDuplicate(this.state.code, this.state.listCheckSame, 1)}
                            </span>
                        </Col>
                        <Col span={12} >
                            Tên thuộc tính:
