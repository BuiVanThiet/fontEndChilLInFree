                        ...
                        <>
                            ...
                            <br />
                            {
                                this.state.attribute?.object1 === attribute.object1 ?
                                    <span className="text-red-600">
                                        {validateString(this.state.attribute.object2) === true ? '' : '*Tên thuộc tính ' + validateString(this.state.attribute.object2)}
                                        {checkDuplicate(this.state.attribute.object3, this.state.listCheckSame, 1) === true ? '' : '*Mã thuộc tính ' + checkDuplicate(this.state.attribute.object2, this.state.listCheckSame, 1)}
                                    </span>
                                    : ''
                            }
                        </>
