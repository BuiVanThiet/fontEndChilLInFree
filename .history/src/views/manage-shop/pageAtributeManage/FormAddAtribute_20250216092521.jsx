...
class FormAddAtribute extends React.Component {
    ...
    validateAdd = () => {
        ...
        if (checkLenght === true && (valueStatus === 1 || valueStatus === 2)) {
                ...
                >
                    <Row gutter={[16, 16]} >
                        ...
                        <Col span={12} >
                            ...
                            />
                            <span className="text-red-600">{validateString(this.state.name) === true ? '' : '*Tên thuộc tính ' + validateString(this.state.code)}</span>
                            </Col>
                        <Col span={24} >
                            Trạng thái:
                            <br />
