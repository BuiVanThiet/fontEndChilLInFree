...
import { fetchProduct, uploadImagePR, createProduct, getProduct, updateProduct, getImageProduct, deleteImagePR } from '../../../store/action/ProductAction';
//attribute
...
class PageUpdateProduct extends React.Component {
    ...
    componentDidMount() {
        ...
        WebSocketService.connect(() => {
            WebSocketService.subscribeSocket(() => this.props.getProduct(id)this.props.getListImage(id), '/topic/product'); // Sử dụng arrow function
    ...
    render() {
        ...
        // this.props.getProduct(id)
        // console.log('data bên jsx ', this.props.productById)
        return (
            <>
                <>
...
const mapDispatchToProps = (dispatch) => ({
    ...
    deleteImagePR: (listImage) => dispatch(deleteImagePR(listImage)),
