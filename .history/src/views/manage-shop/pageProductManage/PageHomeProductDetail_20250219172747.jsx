                        ...
                        {this.state.selectedRowIdsProductDetail.includes(data.object1) ? (
                            <>
                                ...
                                <span className="text-red-600">
                                        ...
                                        validateSelect(removeCommas(this.state.dataChangeUpdate.filter(item => item.object1 === data.object1).map(item => item.object14))) === true ?
                                            // <>

                                            // </> :

                                            // <>
                                            //     {'* Số lượng ' + validateSelect(removeCommas(this.state.dataChangeUpdate.filter(item => item.object1 === data.object1).map(item => item.object14)))}
                                            // </>
