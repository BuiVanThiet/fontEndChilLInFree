                ...
                render: (_, product) => (
                    <Space size="middle">
                        ...
                        <Link to={`/manage/product/${product.object1}`}>
                            <Button color="danger" variant="dashed" onClick={async () => {await this.props.startLoading(); await this.props.resetDataProductEdit() await this.props.}}>Thông tin chi tiết</Button>
                        </Link>
                    </Space>
                ),
            },
