        ...
        return (<>
            ...
            {this.state.selectedRowIdsProductDetail.length > 0 ?
                <div className="flex justify-between mt-3 mb-3">
                    <Button className="bg-red-500 text-white border-red-500 hover:bg-red-600" onClick={() => this.saveUpdateProductDetail()}>
                        Lưu thay đổi
                    </Button>
                    <Button className="bg-blue-500 text-white border-blue-500 hover:bg-blue-600" onClick={() => this.handleAddNew()}>
                        Thêm mới
                    </Button>
                </div>
