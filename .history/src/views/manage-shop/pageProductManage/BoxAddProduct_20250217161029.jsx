                    ...
                    <Row gutter={[16, 16]} align="middle" className="">
                        <Col span={8}>
                            ...
                            <span className="text-red-600">
                                {validateString(productData.codeProduct) === true ? '' : '*Mã sản phẩm ' + validateString(productData.codeProduct)}
                        ...
                        <Col span={24} className="flex justify-end gap-3">
                            {this.props.idProduct ? (
                                <>
                                    ...
                                    <Button color="danger" disabled={!this.state.disabledAddProduct} variant="dashed" onClick={() => this.saveProduct(2, null)}>
                                        Cập nhật sản phẩm
                                    </Button>
                                </>

                            ) : (<Button color="danger" disabled={!this.state.disabledAddProduct} variant="dashed" onClick={() => this.saveProduct(1, null)}>
                                Thêm mới sản phẩm
                            </Button>)}
