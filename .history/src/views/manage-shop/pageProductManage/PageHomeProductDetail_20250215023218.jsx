...
class PageHomeProductDetail extends React.Component {
    ...
    render() {
                ...
                render: (_, data) => (
                    <div className="flex items-center justify-start space-x-2">
                        {this.state.selectedRowKeysProductDetail.includes(data.object1) ? (
                            <Input value={formatNumberWithCommasText(this.state.dataChangeUpdate.object14 ? this.state.dataChangeUpdate.object14 : 0)} onChange={(e) => this.changeMultyData(formatNumberWithCommas(e.target.value), 'object14', data.object1)} />
                        ) : (
        ...
        console.log('data chi tiet: ', this.state.dataChangeUpdate.object14)
        return (<>
