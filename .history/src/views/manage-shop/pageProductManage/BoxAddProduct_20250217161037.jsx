                    ...
                    <Row gutter={[16, 16]} align="middle" className="">
                        <Col span={8}>
                            ...
                            <span className="text-red-600">
                                ...
                                {checkDuplicate(productData.codeProduct, convertData(this.props.products), 2, 'object1', product.object1) === true ? '' : '*Mã sản phẩm ' + checkDuplicate(this.state.productData?.object2, convertData(this.props.products), 2, 'object1', product.object1)}
