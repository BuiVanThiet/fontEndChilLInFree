...
class BoxAddProduct extends React.Component {
    ...
    validateAddOrUpdate = () => {
        ...
        let { productData, fileList, listImageUpload } = this.state;
    ...
    saveProduct = async (checkForm, propsAddProductDetail) => {
        ...
        await this.props.uploadImagePR(this.state.listImageUpload);
        ...
        if (checkForm === 1) {
            ...
            this.setState({ listImageDelete: [], listImageUpload: [] })
        }
    ...
    handleChange = ({ fileList }) => {
        this.setState({ fileList, listImageUpload: fileList }, () => {
            this.validateAddOrUpdate();
        });
    };
    ...
    render() {
        ...
        return (
            <>
                ...
                {
                    !this.props.idProduct ? <BoxAddProductDetail saveProduct={this.saveProduct} checkDataAddProduct={this.state.disabledAddProduct} /> : ''
                }
            </>
        );
    }
