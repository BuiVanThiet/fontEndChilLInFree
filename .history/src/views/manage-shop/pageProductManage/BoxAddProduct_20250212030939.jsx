...
class BoxAddProduct extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        if (prevProps.productById !== this.props.productById) {
            this.setState({ productData: this.props.productById, fileList: this.props.ListImage }, () => { console.log('data anh', this.props.fileList) });
    ...
    saveProduct = async (checkForm) => {
        ...
        if (checkForm === 1) {
            ...
            console.log('anh xoa ben jsx ', this.state.listImageDelete)
                    ...
                    <Row gutter={[16, 16]} align="middle" className="">
                        ...
                        <Col span={24}>
                            <Upload
                                ...
                                multiple
                            >
                                {data && fileList.length >= 20 ? null : uploadButton}
                            </Upload>
                            {previewImage && (
                                <Image
                                    wrapperStyle={{
