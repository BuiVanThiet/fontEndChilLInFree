...
class PageHomeProductDetail extends React.Component {
    ...
    saveUpdateProductDetail = async () => {
        ...
        await const newData = this.state.dataChangeUpdate.map(({ object1, object5, object2, object14, object12, object13, object11, object8 }) => ({
            id: object1,
            idProduct: id,
            idColor: object5,
            idSize: object2,
        ...
        this.props.getUpdateProductDetail(newData, id);
        this.setState({ selectedRowKeysProductDetail: [], dataChangeUpdate: [] });
