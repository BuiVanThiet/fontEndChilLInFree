...
class PageProductRouter extends React.Component {
    ...
    validateProduct = (id,code, name, status, idCategory, idManufacturer, idOrigin, describe, listImage, addOrUpdate) => {
        let checkLenght = (
        ...
        if (addOrUpdate === 1) { //1 la them 2 la update
            ...
            checkSame = checkDuplicate(code, listProduct, addOrUpdate,'object1',);
        }
