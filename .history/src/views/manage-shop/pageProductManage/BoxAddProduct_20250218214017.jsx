                    ...
                    <Row gutter={[16, 16]} align="middle" className="">
                        <Col span={8}>
                            ...
                            <span className="text-red-600">
                                ...
                                {checkDuplicate(productData.codeProduct, convertData(this.props.products), 1)}
                                {checkDuplicate(productData.codeProduct, convertData(this.props.products), 2, 'object1', productData.id) === true ? '' : '*Mã sản phẩm ' + }
                            </span>
                        </Col>
                        <Col span={8}>
                            Tên sản phẩm:
