...
class PageAddProductDetail extends React.Component {
    ...
    saveProductDetail = (checkForm) => {
        ...
        if (checkForm === 1) {
            this.props.getAddProductDetail(newData);
        }
        ...
        console.log('data chi tiet de them:', newData)
    }
    ...
    render() {
        ...
        return (
            <>
                <>
                    {
                        id ? <Link to={`/manage/product/${this.props.idProduct}/home-product-detail`}>
                    ...
                    <div className="flex items-end justify-end mt-3">
                        <Button
                            ...
                            onClick={() => this.props.saveProduct(1, this.saveProductDetail)}
                        >
