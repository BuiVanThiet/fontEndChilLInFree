                            ...
                            <span className="text-red-600">
                                {validateString(productData.codeProduct, 255) === true ? '' : '*Mã sản phẩm ' + validateString(productData.codeProduct, 255)}
                                {
                                    ...
                                    this.props.idProduct ?
                                        (checkDuplicate(productData.codeProduct, this.props.listProduct, 1) === true  's' : '*Mã sản phẩm '+checkDuplicate(productData.codeProduct,this.props.listProduct,1))
                                : (checkDuplicate(productData.codeProduct,this.props.listProduct,2,'object1',this.props.idProduct))
                                }
                            </span>
                        </Col>
                        <Col span={8}>
