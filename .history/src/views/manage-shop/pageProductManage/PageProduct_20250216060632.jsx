                ...
                render: (_, product) => (
                    <Space size="middle">
                        {this.state.productData?.object1 === product.object1 ?
                            (
                                <>
                                    <Button color="danger" variant="dashed" onClick={async () => {
                                        await this.props.startLoading(); onClick={async () => { await this.props.startLoading(); await this.props.stopLoading(); }}
                                        await this.saveUpdateProduct(this.state.productData);}}>Lưu</Button>
