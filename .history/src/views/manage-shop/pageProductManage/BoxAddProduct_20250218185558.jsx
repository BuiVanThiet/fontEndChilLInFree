                            ...
                            <span className="text-red-600">
                                {validateString(productData.codeProduct, 255) === true ? '' : '*Mã sản phẩm ' + validateString(productData.codeProduct, 255)}
                                {
                                    ...
                                    !this.props.idProduct ?
                                        ...
                                        : (checkDuplicate(productData.codeProduct, this.props.listProduct, 2, 'object1', this.props.) === true ? '' : '*Mã sản phẩm ' + checkDuplicate(this.state.productData?.object2, convertData(this.props.products), 2, 'object1', product.object1))
                                }
                            </span>
                        </Col>
                        <Col span={8}>
