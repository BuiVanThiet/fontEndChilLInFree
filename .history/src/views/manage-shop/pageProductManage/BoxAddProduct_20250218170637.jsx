                        ...
                        <Col span={8}>
                            ...
                            <span className="text-red-600">
                                {validateString(productData.codeProduct,255) === true ? '' : '*Mã sản phẩm ' + validateString(productData.codeProduct,255)}
                                {
                                    ...
                                    (checkDuplicate(productData.codeProduct,this.props.listProduct,1)) : (checkDuplicate(productData.codeProduct,this.props.listProduct,2,'object1',this.props.idProduct))
                                }
                            </span>
                        </Col>
                        <Col span={8}>
