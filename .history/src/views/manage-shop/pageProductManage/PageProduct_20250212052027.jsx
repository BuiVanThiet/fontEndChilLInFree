...
class PageProduct extends React.Component {
    ...
    saveUpdateProduct = (productData) => {
        ...
        console.log('data save update: ', dataProduct)

        this.props.getUpdateProduct(dataProduct);
            ...
            },
            {
                ...
                render: (_, product) => (
                    <Space size="middle">
                        ...
                        <Link to={`/manage/product/${product.object1}` onClick={() => this.props.resetDataProductEdit()}}>
                            <Button color="danger" variant="dashed">Thông tin chi tiết</Button>
                        </Link>
                    </Space>
                ),
            },
        ...
        return (
            <>
                ...
                <Link to="/manage/product/add-product-new">
                    <Button className="mt-3 mb-3" color="danger" variant="dashed">
