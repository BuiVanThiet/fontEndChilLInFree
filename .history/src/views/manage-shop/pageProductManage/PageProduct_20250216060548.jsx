                ...
                render: (_, product) => (
                    <Space size="middle">
                        {this.state.productData?.object1 === product.object1 ?
                            (
                                <>
                                    <Button color="danger" variant="dashed" onClick={() => {onClick={async () => { await this.props.startLoading(); await this.props.stopLoading(); }}this.saveUpdateProduct(this.state.productData)}}>Lưu</Button>
