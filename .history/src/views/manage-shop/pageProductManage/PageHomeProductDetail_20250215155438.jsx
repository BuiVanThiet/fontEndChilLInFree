...
class PageHomeProductDetail extends React.Component {
    ...
    saveUpdateProductDetail = () => {
        const newData = this.state.dataChangeUpdate.map(({ object1, object5, object2, object14, object12, object13, object11, object10 }) => ({
            id: object1,
            idColor: object5,
            idSize: object2,
            quntity: object14,
...
const mapDispatchToProps = (dispatch) => ({
    ...
    getUpdateProductDetail: (list) => dispatch(getUpdateProductDetail(list)),
});
