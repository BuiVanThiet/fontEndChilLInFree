                ...
                <Card type="inner">
                    <Row gutter={[16, 16]} align="middle" className="">
                            ...
                            <span className="text-red-600">
                                {validateString(productData.codeProduct, 255) === true ? '' : '*Mã sản phẩm ' + validateString(productData.codeProduct, 255)}
                                {
                                    ...
                                    !this.props.idProduct ?
                                        (checkDuplicate(productData.codeProduct, this.props.listProduct, 1) === true ? '' : '*Mã sản phẩm ' + checkDuplicate(productData.codeProduct, this.props.listProduct, 1))
                                        : (checkDuplicate(productData.codeProduct, this.props.listProduct, 2, 'object1', this.props.idProduct) === true ? '' : '*Mã sản phẩm ' + checkDuplicate(productData.codeProduct, this.props.listProduct, 2, 'object1', this.props.idProduct))
                                }
                            </span>
                        </Col>
                        <Col span={8}>
                        ...
                        <Col span={8}>
                            ...
                            />
                            <span className="text-red-600">
                                {validateSelect(productData.idCategory) === true ? '' : '*Danh mục sản phẩm ' + validateString(productData.nameProduct, 255)}
                            </span>
                        </Col>
                        <Col span={8}>
                            Nhà sản xuất:
                        ...
                        <Col span={24} className="flex justify-end gap-3">
                            ...
                            ) : (<Button color="danger" variant="dashed" onClick={() => this.saveProduct(1, null)}>
                                Thêm mới sản phẩm
                            </Button>)}
