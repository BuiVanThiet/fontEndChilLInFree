...
import { validateInteger, removeCommas } from '../../../store/action/ActionRenderData';
                ...
                render: (_, data) => (
                    <div className="items-center justify-start space-x-2">
                        ...
                        <span className="text-red-600">
                            {validateInteger(removeCommas(data?.quantity) === true ? '' : '*Số lượng ' + validateInteger(removeCommas(data?.quantity))}
                        </span>
                    </div>
                ),
                width: 240,
