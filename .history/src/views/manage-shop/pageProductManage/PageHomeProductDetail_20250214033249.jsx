...
class PageHomeProductDetail extends React.Component {
    ...
    render() {
        ...
        return (<>
            ...
            <BoxTable columnsColor={columns} dataColor={convertData(this.props.listProductDetail)} checkBoxTable={1} columnsColor={columns} dataColor={listData} checkBoxTable={1} rowSelection={rowSelection} />
        </>)
    }
}
