                    ...
                    this.state.productData?.object1 === product.object1 ?
                        <>
                            ...
                            <span className="text-red-600">
                                {validateString(this.state.productData?.object2, 255) === true ? '' : '*Mã sản phẩm ' + validateString(this.state.productData?.object2, 255)}
                                {checkDuplicate(this.state.productData?.object2, convertData(this.props.products), 2, 'object1', product.object1) === true ? '' : '*Mã sản phẩm ' + checkDuplicate(this.state.productData?.object2, convertData(this.props.products), 2, 'object1', product.object1)}
                            </span>
                        </>
                        : product.object2
                ),
                ...
                render: (_, product) => (
                    this.state.productData?.object1 === product.object1 ?
                        <>
                            ...
                            <span className="text-red-600">
                                {validateString(this.state.productData?.object3, 255) === true ? '' : '*Tên sản phẩm ' + validateString(this.state.productData?.object3, 255)}
                            </span>
                        </>
                        : product.object3
                ),
                ...
                render: (_, product) => (
                    <>
...

                        {
                            this.state.productData?.object1 === product.object1 ?
                                <span className="text-red-600">
                                    {validateString(this.state.productData.object10, 500) === true ? '' : '*Mô tả ' + validateString(this.state.productData.object10, 500)}
                                </span> : ''
                        }
                    </>
                ),
        ...
        return (
            <>
                ...
                <Link to="/manage/product/add-product-new">
                    <Button className="mt-3 mb-3" color="danger" variant="dashed" onClick={() => this.props.onClickLoadPage()}>
