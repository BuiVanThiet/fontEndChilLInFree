...
class PageAddProductDetail extends React.Component {
    ...
    saveProductDetail = () => {
        console.log('data chi tiet de them:', this.state.productVariations)
        const newData = this.state.dataChangeUpdate.map(({ color, size, quantity, importPrice, sellingPrice, weight, weightType, status }) => ({
            idColor: color.id,
            idSize: size.id,
            quantity: quantity,
            ...
            <>
                <>
                    ...
                    <div className="flex items-end justify-end mt-3">
                        <Button color="danger" variant="dashed" onClick={() => this.saveProductDetail()}>
...
export default connect(mapStateToProps, mapDispatchToProps)(PageAddProductDetail);