...
import {
    convertData,formatNumberWithCommasText
                        ...
                        <div className="bvt-price justify-center">
                            {
                                this.props.priceMin === this.props.priceMax
                                    ? <span className="ml-2 text-red-500 ">{this.props.priceMin} VNĐ</span>
                                    : <span className="ml-2 text-red-500">{this.props.priceMin} VNĐ -> {this.props.priceMax} VNĐ</span>
                            }
                            {/* 
