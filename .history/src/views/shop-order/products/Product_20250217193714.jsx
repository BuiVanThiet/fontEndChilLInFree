                        ...
                        <div className="bvt-price">
                            {
                                ...
                                ? <span className="ml-2 line-through text-gray-600 ">{this.props.priceMin} VNĐ</span>
                                : <span className="ml-2 line-through text-gray-600 ">{this.props.priceMin} - {this.props.priceMax} VNĐ</span>
                            }
