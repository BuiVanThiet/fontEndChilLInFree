...
class PageProductDetail extends React.Component {
    ...
    onChangeIdSize = (e) => {
        this.setState({ valueStatus: e.target.value }, () => this.props.fetchPriceSeling(idPR, this.state.idS, this.state.idC));
    }
                                                ...
                                                <span className="text-red-500 text-[20px]">
                                                    {
                                                        (this.state.idC != null && this.state.idS != null) ?
                                                            formatNumberWithCommasText(this.props.priceSeling[0])
                                                            :
                                                            <>
