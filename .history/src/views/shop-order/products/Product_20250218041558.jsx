...
import { START_LOADING, STOP_LOADING } from '../../';
        ...
        return (
            <>
                <div className="bvt-product-card h-[600px] flex flex-col items-center">
                    <div
                        className="h-[70%] w-full duration-500 bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${this.props.image})` }}>
                        <div
                            ...
                            <div className="absolute w-full bottom-4 hidden justify-center group-hover:flex">
                                <button
                                    ...
                                    <span className="relative z-10" onClick={() => this.props.onClickPage()}>
                    ...
                    <div className="text-center mt-8">
                        <Link to={`/product/product_detail/${this.props.idProduct}`}>
                            <div className="text-xl mb-3 hover:text-red-700" onClick={() => this.props.onClickPage()}>{this.props.nameProduct}</div>
                        </Link>
