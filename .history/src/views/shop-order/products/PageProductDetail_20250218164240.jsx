    ...
    render() {
        ...
        if (this.props.priceSeling && this.props.priceSeling.length > 0) {
            if (this.state.idC !== null && this.state.idS !== null) {
                ...
                checkQuantity = this.props.priceSeling[0][1] > 0 ? true : false;
            } else {
                priceMin = this.props.priceSeling[0][0];
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                ...
                                <div className="flex flex-col col items-center justify-center w-full col-1">
                                    <Card className="w-full">
                                        ...
                                        <Button type="dashed" disabled={!checkQuantity} block style={{ height: '50px' }} className="text-[20px]" onClick={() => this.open()}>
                                            Thêm vào giỏ hàng
                                        </Button>
                                        <this.props.Link to="/order">
                                            <Button type="dashed" disabled={!checkQuantity} danger block style={{ height: '50px' }} className="text-[20px] mt-5">
                                                Mua ngay
                                            </Button>
                                        </this.props.Link>
                                    </Card>
