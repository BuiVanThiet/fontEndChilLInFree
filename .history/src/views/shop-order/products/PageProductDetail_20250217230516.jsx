...
class PageProductDetail extends React.Component {
    ...
    render() {
        console.log('Thong tin san pham chi tiet:', this.props.priceSeling)
        render() {
            // Kiểm tra xem priceSeling có phải là null hoặc undefined không
            if (this.props.priceSeling && this.props.priceSeling.length > 0) {
                console.log('data gia:', this.props.priceSeling[0]);
            } else {
                console.log('Không có giá bán');
            }

            // Các phần còn lại của render...
        }
